#!/usr/bin/env python3
"""
Wordnik API Integration for Stanzle Game
Fetches random words, themes, and emotions from Wordnik API
"""
...
class WordnikIntegration:
    ...
    def get_random_words(self, count=4):
    ...
    def get_word_definitions(self, words):
...
if __name__ == "__main__":
    ...
    print(f"Emotion: {challenge['emotion']}")
    print(f"Words: {challenge['words']}")
